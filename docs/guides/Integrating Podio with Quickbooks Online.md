...
We also offer pay-as-you-go customization. If you are interested in either of the above, please [**[get in touch]{.underline}**](https://forms.momentumtools.io/?form=lqjomvmsqiir&services-requested=5&what-would-you-like-to-purchase%5b6%5d=true) and we are happy to help.
...
- **[[Intuit Developer account:]{.underline}](https://developer.intuit.com/app/developer/homepage) **Sign in with your Quickbooks Online credentials
...
Log in to your [[Intuit Developer Account]{.underline}](https://developer.intuit.com/app/developer/homepage) and select \"My Apps\" at the top. Follow the steps to create an app for Quickbooks Online and Payments. You can name the app whatever you like, and select Accounting for the scope. 
...
In the Redirect URIs section, select \"Add URI\" and add [[https://procfu.com/authenticate.php]{.underline}](https://procfu.com/authenticate.php).

**Step 3: Set up API Configuration in ProcFu**

ProcFu is what will allow Podio to communicate with Quickbooks Online\'s developer API. To begin this setup, log in to ProcFu and go to Menu -\> Configuration. In the upper right, click the \"[[Add API]{.underline}](https://procfu.com/apiService.php?id=0)\" link. Fill out the next page with the following:
...
- **Authorize URL:** [[https://appcenter.intuit.com/connect/oauth2]{.underline}](https://appcenter.intuit.com/connect/oauth2)

- **Scopes: **com.intuit.quickbooks.accounting

- **Access Token URL:** [[https://oauth.platform.intuit.com/oauth2/v1/tokens/bearer]{.underline}](https://oauth.platform.intuit.com/oauth2/v1/tokens/bearer)

- **Resource Owner Details URL:** [[https://accounts.platform.intuit.com/v1/openid_connect/userinfo]{.underline}](https://accounts.platform.intuit.com/v1/openid_connect/userinfo)
...
Send this payload using [[ProcFu\'s Make API Request script]{.underline}](http://procfu.com/script.php?s=api_make_request.pf). The URL for this particular call is:

[[https://quickbooks.api.intuit.com/v3/company/{CompanyID}/customer]{.underline}](https://quickbooks.api.intuit.com/v3/company/%7BCompanyID%7D/customer)
...
Be sure to thoroughly test these flows prior to using them with your customers. And as always, if you have any questions, do not hesitate to [[get in touch]{.underline}](https://forms.momentumtools.io/?form=lqjomvmsqiir&services-requested=5&what-would-you-like-to-purchase%5b6%5d=true) and we will be happy to assist. 
